        ...
        <div class="card-body">
            <form class="custom-membership-form">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <label class="form-label">Logo  (Web Portal)</label>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        <!-- Editor Name (as per Aadhaar) -->
                        <label class="form-label">Editor/Beauro Chief/Reporter/Cameraman <span id="red">*</span></label>
                        <input type="text" class="form-control" name="name" required placeholder="Enter Editor/Beauro Chief/Reporter/Cameraman">
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <label for="" class="form-label">Photo (Passport Size) <spn id="red">*</spn></label>
                    ...
                    <div class="col-md-12">
                        <label for="tc">
                            <input type="checkbox" id="tc" requried>
                            I have understand and agree to all the AIWNPC Terms and Conditions.
                        </label>
                    </div>
                </div>
